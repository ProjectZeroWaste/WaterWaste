...
def display(confusion_matrix, categories, output_path):
    ...
    cm.to_csv(output_path[:-4]+"heat.csv")
    
def main(argv):
    del argv
    required_flags = ['detections_record', 'label_map', 'output_path']
    #DEBUG
    #FLAGS.output_path = '/mnt/omreast_users/phhale/csiro_trashnet/experiments/tfodapi/ds0v5/frcnn_inception_vs_ds0v5_102620_step50k/confusion_matrix.csv'
    #FLAGS.detections_record = '/mnt/omreast_users/phhale/csiro_trashnet/experiments/tfodapi/test_detection.tfrecord'
    #FLAGS.label_map = '/mnt/omreast_users/phhale/csiro_trashnet/datasets/ds0v5/tf_ds/labelmap.pbtxt'
